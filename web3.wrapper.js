...
var Wrapper = Proxy;
var TransactionX = require('./custom-eth-tx/');
...
const HDWalletProviderWrapper = function (hdWallet) {
	...
	const processSignTransaction = function (txParams, cb) {
		let args = arguments;
		cb(null, txParams);
	};
	// hdWallet.engine._providers[0].processSignTransaction = processSignTransaction.bind(hdWallet);
